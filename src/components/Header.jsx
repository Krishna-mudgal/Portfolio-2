...
const tags = ["FullStack Developer", "AIML Engineer"];
  ...
  return (
    ...
    >
      <div className='flex flex-col items-center justify-center gap-4'>
        ...
        >
          <img src={profile} alt='' className='rounded-full w-24 sm:w-28 md:w-32' />
        </motion.div>
        ...
        <motion.h3
          ...
          className={`flex items-end justify-center gap-2 text-base sm:text-xl md:text-2xl mb-3 ${isDarkMode ? "text-gray-100" : "text-gray-700"}`}
        >
        ...
        <motion.h1
          ...
          className='text-2xl sm:text-4xl md:text-6xl lg:text-[66px]'
        >
        ...
        <motion.p
          ...
          className={`w-full max-w-lg px-2 sm:px-4 ${isDarkMode ? "text-gray-100" : "text-gray-700"}`}
        >
        ...
        <div className='flex flex-col sm:flex-row items-center justify-center gap-2 w-full'>
          ...
          >
            <Link
              to="/contact"
              className={`w-full sm:w-auto px-8 py-3 border border-gray-500 rounded-full flex items-center gap-2 justify-center ${isDarkMode ? "text-gray-100" : "bg-black text-white"}`}
            >
          ...
          >
            <a
              ...
              download={true}
              className={`w-full sm:w-auto px-8 py-3 border rounded-full border-gray-500 flex items-center gap-2 justify-center ${isDarkMode ? "bg-white text-gray-800" : ""}`}
            >
              my resume
